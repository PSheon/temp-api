...
const Chart1 = new ApexCharts(document.querySelector('#spark1'), spark1)
...
socket.on('asm_stats', (asm_stats) => {
  ...
  // os
  // retention
  if (asm_stats.interval === 1) {
    if (spark1Data.length === 60) {
      spark1Data.shift()
    }

    console.log('spark1Data, ', spark1Data)

    spark1Data.push(asm_stats.os.cpu)

    Chart1.updateSeries([{ data: spark1Data }])
  }
})
